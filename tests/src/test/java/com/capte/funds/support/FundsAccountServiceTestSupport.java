...
public final class FundsAccountServiceTestSupport {
    ...
    public static LedgerService ledgerServiceWithCreateRecorder(List<CreateLedgerRequest> requests) {
    ...
    public static LedgerService unsupportedLedgerService() {
        return new UnsupportedLedgerService();
    }
    ...
    public static final class RecordingSubjectLedgerInitializer implements SubjectLedgerInitializer {
        ...
        public InitializeSubjectLedgerRequest getRequest() {
            return request;
        }
    }
