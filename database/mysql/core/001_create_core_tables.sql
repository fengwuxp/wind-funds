-- wind-funds core MySQL 8.0+ forward migration.
-- Generated from the executable test schema; production rollout must register this file in the host migration system.
-- ----------------------------
-- 资金账户表
-- ----------------------------
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '账户层级关系表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '支付工具绑定历史表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '支出主体资金关系表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'Spend Rule 决策记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '支出控制额度变动表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '账户账本交易表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '账户账本记账计划表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '账户账本条目表';
