...
P0-H-006 和 P0-H-007 已完成：三类服务测试矩阵和业务组合集成测试已补齐，测试包名已按能力归属小批次对齐。下一批进入 P0-ROUTE：路由层 CR、场景 100% 覆盖、replay 语义收敛和过时入口清理。清分、清算、对账、账本账目归档、余额快照、完整 FX 运营对象和相关运营工作台全部排入下版本。
