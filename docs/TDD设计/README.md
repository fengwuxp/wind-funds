...
| `firstRedSet` | `SR-HN-002-RED-001` 至 `SR-HN-002-RED-011`。 |
...
| `nextGate` | SR-HN-002 当前收口；AVS、card transaction processing type、多规则冲突和表达式引擎均另拆任务。 |
