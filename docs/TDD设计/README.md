...
| `firstRedSet` | `SR-HN-002-RED-001` 至 `SR-HN-002-RED-007`。 |
...
| `nextGate` | SR-HN-002 当前收口；商户 ID、POS、PAN entry、CVV、AVS、card transaction processing type、多规则冲突和表达式引擎均另拆任务。 |
