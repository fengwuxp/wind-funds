...
| 8 | [GSD-2-P0P1-LedgerWalletTransaction推进计划.md](GSD-2-P0P1-LedgerWalletTransaction推进计划.md) | GSD-2 Wave 5 P0/P1 ledger、wallet、transaction 优先推进计划，当前账户层级、资金责任、支付工具能力准入、支付工具授权准入、交易投影解释、余额调账审计、B7 差错闭环、动作守卫、准入消费和出款 preflight 首个消费方接入均已完成首轮 Green；当前状态为 `WALLET_AUTHORIZATION_ADMISSION_GREEN_VERIFIED`，下一候选默认收敛为 `GSD2-B2-WALLET-AUTHORIZATION-ROUTE-SNAPSHOT-001`；若不继续 wallet，再改选 ledger guard、清算/结算消费方接入、B7 差异报告或 B5 审计扩展。 |
