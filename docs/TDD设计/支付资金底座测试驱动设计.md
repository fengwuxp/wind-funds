...
| `DSL-AUTH-REFUND-001` | 授权链退款、无授权直接退款和争议类退款原因承接。 | `TDD-AUTH-005` 至 `TDD-AUTH-007`、`TDD-AUTH-FLOW-005`、`TDD-AUTH-FLOW-008`、`TDD-ROUTE-005`、`TDD-RED-003`、`TDD-RED-017A`。 | route replay、settle refund service、refund reason/audit projector、posting assertion。 | `TDD-RED-003`、`TDD-RED-017A`、`TDD-RED-036`。 |
