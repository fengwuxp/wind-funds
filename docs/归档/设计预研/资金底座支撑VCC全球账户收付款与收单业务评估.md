...
> 归档说明：本文为早期三类业务支撑评估，稳定结论已沉淀到当前产品设计、系分设计和用户接入指南。本文只作为历史背景，不作为当前权威设计、编码准入或生产交付依据。
...
| 重放或归档差异 | 余额投影、交易投影、财务核对视图或指标项输入与账本事实不一致。 | 以账本分录和归档清单为事实源重放。 | 生成差异报告，按批次修复投影或指标项输入。 | 重放不改变原交易事实或历史分录，不生成正式财务报表。 |
