...
| status | CREATED、PARTIALLY_RECOVERED、RECOVERED。 |
...
| idx_settlement_order_status | tenant_id, status, gmt_modified | 结算状态扫描 |
...
| currency | varchar(10) | [X] | 币种 | CNY |
| status | varchar(30) | [X] | CREATED、PARTIALLY_RECOVERED、RECOVERED | PARTIALLY_RECOVERED |
...
| 索引名称 | 索引字段 | 索引用途 |
| --- | --- | --- |
| idx_recovery_order_subject_status | tenant_id, responsible_subject_type, responsible_subject_id, status, gmt_modified | 责任主体状态扫描 |
