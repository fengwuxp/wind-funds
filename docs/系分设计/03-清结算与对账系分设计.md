...
| SettlementOrderStatus | 结算单状态 | DRAFT、REVIEWING、APPROVED、LOCKED、FAILED、CANCELLED；FAILED 只表达锁定资金的明确账务拒绝，出款状态不进入本枚举 |
| PayoutOrderStatus | 出款单状态 | CREATED、SUBMITTED、ACCEPTED、PROCESSING、SUCCEEDED、FAILED、RETURNED、MISMATCHED |
| RecoveryOrderStatus | 追偿责任事实状态 | CREATED、PARTIALLY_RECOVERED、RECOVERED；抵扣中、催收中属于宿主流程状态，核销/取消尚未纳入 W3 |
