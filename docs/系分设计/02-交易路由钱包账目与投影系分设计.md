...
| 预算控制投影 | 从控制活动聚合控制口径的 reservedAmount、consumedAmount、releasedAmount、remainingControlAmount、lastActivitySn 和 lastActivityAt。 | 不包含 ledger balance、available balance、frozen balance 或 authorization balance；不得反写账本余额；`consumedAmount` 是否落入首轮代码取决于新的单一 Grant。 |
