...
| 优先级 | 产品能力 | 系统模块 | 核心契约 |
| --- | --- | --- | --- |
| P0 | 钱包账户 | wallet-face、wallet-impl | FundingAccountService、CreditAccountService、BudgetGroupService、PaymentInstrumentService。 |
...
| Phase 3 清结算对账投影 | 清分明细、清算候选、对账差错、交易投影、运营和财务视图。 | 展示和核对商户让利、平台补贴、代金券核销、补贴冲回、不退券和权益差异。 | 不用清结算或报表结果反写交易事实、账本分录或营销权益状态。 |
...
| P1 | 交易投影 | 用户账单、商户账单、运营时间线和财务视图。 | 投影只读、来源可追溯、无范围重放失败测试通过。 |
