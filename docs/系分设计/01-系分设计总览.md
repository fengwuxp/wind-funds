...
| [03-清结算与对账系分设计.md](03-清结算与对账系分设计.md) | 清算候选、清算批次、清算批次明细、结算单、结算金额项、出款单、对账批次、对账匹配结果、差错单、追偿单、操作审计。 |
...
| 清结算对账 | 清算候选、批次、结算单、出款单、对账批次、差错单、追偿单。 | 对象独立、状态独立、账务动作引用交易层、差错闭环和审计测试齐备。 |
