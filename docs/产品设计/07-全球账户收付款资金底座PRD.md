...
| 可记账主体 | 内部资金账户、在途账户、差错账户、平台账户角色 | `wind-funds` 内部资金和账务主体。 | 承载余额、费用、退汇和差错。 | 是。 |
...
本表中的 P0/P1 只表示全球账户分册内部建设顺序，不改变 01 总览中“全球账户收付款属于全局 P2 业务补充分册”的定位。任何全球账户能力进入编码前，都必须先证明复用统一钱包、账本、账目、清结算、对账和归档能力，并获得独立 Execution Grant。
...
| 04-归档重放与指标治理 | 补充全球账户客户账单、在途解释和多币种投影重放。 |
