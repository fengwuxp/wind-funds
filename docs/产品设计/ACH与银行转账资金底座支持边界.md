...
| --- | --- | --- |
| 钱包账户 | 不需要 | ACH 只影响外部账户引用和资金来源解释；内部入账主体仍是资金账户、信用账户、预算组或平台账户角色。 |
| 账本账目 | 不需要 | 复用 AVAILABLE、IN_TRANSIT、CLEARING、SETTLEMENT、PAYOUT_IN_TRANSIT 等账目；是否新增账目必须由具体 Execution Grant 证明。 |
...
ACH 或银行转账相关能力进入编码前，Execution Grant 必须额外说明：
