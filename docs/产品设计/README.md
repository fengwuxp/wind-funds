...
| 金融红线 | 法域、资质、客户资金、商户待结算资金、KYC/KYB/AML、敏感信息和外部规则均有待确认方或确认结论。 | 带条件通过或阻断；不得写成上线或合规结论。 |
...
| 03 清结算与对账 | 对象、状态、阻断、差错和人工处理闭环已定义。 | 独立实现对象、服务契约、DDL/H2 schema、状态机、服务级测试和外部规则确认。 |
| 04 归档、重放与指标项边界 | 归档、重放、余额快照和指标只读边界已定义。 | Manifest、checkpoint、watermark、范围锁、差异报告、回滚/续跑和指标模块接口边界验证。 |
