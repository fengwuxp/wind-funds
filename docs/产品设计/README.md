...
01-05 是资金底座主线 PRD，06-08 是三类资金业务的业务补充分册。06-08 不替代主线，用于说明业务场景如何通过场景交易 capability pack 接入统一资金内核。能复用三类资金业务的能力回到 01-05，业务专属状态机、外部引用、规则待确认项和验收样例保留在 06-08。商品订单交易体系属于上层业务系统预研，不进入本目录最终交付分册；如需参考，查看 [../归档/设计预研/商品订单交易体系/商品订单交易体系重构设计.md](../归档/设计预研/商品订单交易体系/商品订单交易体系重构设计.md)。ACH 与银行转账边界文档不是业务分册，它只定义外部银行转账轨道如何被资金底座支持以及哪些能力不得沉入 `wind-funds`。
