...
| 产品能力 | 准入顺序 | 产品侧必须给出的准入材料 | 不应混入 |
| --- | --- | --- | --- |
| 直接交易、授权交易、余额控制、交易投影 | 先于 P2 业务专项，作为首批主线编码范围候选。 | 对应 `AC-*`、`RED-*`、资金动作、使用者解释、失败原因、退款/撤销/过期/冻结边界和 Not Done。 | 清结算、对账、归档、治理、VCC/全球账户/收单特殊规则。 |
...
产品侧 A0 输出作为产品评审页使用，直接交给研发和测试承接：
