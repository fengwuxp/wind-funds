...
| 模板项 | 本文落点 | 裁剪说明 |
| --- | --- | --- |
| 需求概览、目标和范围 | 1、2、3、9 | 总览只给全局结论，不复制各专项需求链。 |
| 核心名相、角色和对象 | 4、5 | 统一资金名相与责任主体，具体字段进入专题分册。 |
| 能力、流程和规则 | 6、7、10、13 | 用能力地图、总流程和红线承接。 |
| 数据、运营、风险和确认 | 12、14、15、16 | 保留运营边界、资金安全和外部规则确认。 |
| 验收与下游交接 | 11、14、17 | 验收细节进入 05 矩阵，工程实现进入系分和 TDD。 |
