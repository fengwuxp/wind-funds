...
| --- | --- | --- | --- |
| 多账本 | 用户、商户、平台、银行、通道、卡组织和清算网络各有自己的账本或账务记录。 | 内部资金账户、信用账户、预算组、平台账户角色、账本交易和分录。 | 直接修改外部银行账本、通道账本、清算网络账本或卡组织账本。 |
...
| 资金不变量 | 明确金额闭合、主体、账户类型、`normalBalanceSide`、账目、周期、route、posting、entry、projection、借贷平衡、余额影响、幂等和失败无副作用断言。 | 资金变化场景不得声明完成。 |
