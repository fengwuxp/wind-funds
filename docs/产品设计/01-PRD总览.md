...
| 权益语义层 | 权益让利资金事实、权益金额组件、权益来源引用、退款和撤销处置 | 承接订单、交易业务系统或营销权益系统已经决策完成的优惠券、代金券、平台补贴、商户让利和储值权益结果。 | 权益资金交易和等价不可变事实是回放事实 |
...
| 权益让利资金事实 | 一笔已决策权益对资金、负债、成本、商户应收或对账解释产生的事实，例如平台补贴、商户让利、代金券核销、储值权益和退款冲回。 | 只承接业务侧已决策结果，不重新计算券规则、不维护券包生命周期；后续退款、撤销、清结算、对账和投影必须基于原权益资金交易或等价不可变事实回放。 |
| 权益金额组件 | 权益让利资金事实中的金额拆分，例如商户让利、平台补贴、平台券不补足商户、代金券核销、储值权益、补贴冲回和不可退权益。 | 必须说明谁承担、谁受益、是否入账、是否影响商户应收和退款如何处理；不得与本金、手续费、通道成本混成净额。 |
