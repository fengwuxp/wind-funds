...
| 本轮新增权威补充 | `docs/TDD设计/GSD-2-B7-对账差异报告ExecutionGrant确认包.md` 已从确认包升级为消费记录；`GSD2-B7-RECON-DIFFERENCE-REPORT-001` 已提交到 `a1397ddf`。 |
...
| 活跃未完成编码计划 | `EMPTY`。旧候选不再是当前编码计划，只能作为 backlog reference；`GSD2-AUTH-CHARGEBACK-COMPAT-ADAPTER-001`、`GSD2-B4-TRANSACTION-PROJECTION-EXPLAIN-002` 首轮争议退款、`GSD2-B4-TRANSACTION-PROJECTION-EXPLAIN-002-REMAINING`、`GSD2-B2-WALLET-AUTHORIZATION-ADMISSION-001`、`GSD2-B2-WALLET-AUTHORIZATION-ROUTE-SNAPSHOT-001`、`GSD2-LD-LEDGER-GUARD-REGRESSION-001`、`GSD2-B5-BALANCE-ADJUST-AUDIT-002`、`GSD2-B5-BALANCE-ADJUST-AUDIT-003`、`GSD2-B7-RECON-CLEARING-SETTLEMENT-GATE-CONSUME-001`、`GSD2-B7-RECON-CLEARING-SETTLEMENT-CONSUMER-SERVICE-001` 和 `GSD2-B7-RECON-DIFFERENCE-REPORT-001` 已消费；下一轮不得复用 B5-003、B7 对象级 Gate、B7 consumer 或 B7 report Grant，需重新选择 wallet 完整预交易快照、账户能力来源组合、B7 报告扩展或其他单一 Grant。 |
...
| 下一候选 | 若继续编码，只能在完整预交易快照、账户能力来源组合、Spend Rule 控制闭环、B7 报告扩展或 VCC facade 中重新确认单一 Grant。Spend Rule、VCC、全球账户和 P2 业务仍后置。 |
