...
- [ ] 2026-06-23 计划 `GSD2-CORE-FUNDS-SUBJECT-TYPE-SEMANTIC-GUARD-001`：`FundsSubjectType.BUDGET_GROUP` 保留兼容期枚举，但需补语义 guard 和文档解释，避免预算控制对象被误用为可入账资金主体。本任务暂不授权删除枚举或改写历史数据。
