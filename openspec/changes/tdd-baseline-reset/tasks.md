...
| Git / code baseline | 当前已提交 Git/code baseline 为 `da3b4f19 feat: 补齐余额调账路由审计回链`；本轮 `GSD2-B5-BALANCE-ADJUST-AUDIT-003` 已完成本地 Red / Green / Verify 但仍在未提交工作树，待用户另行授权 Git 后提交固化；`0b251593 feat: 补齐账本正常余额方向护栏` 是进入 B5-002 route snapshot 审计回链切片前的已提交基线；`GSD2-B5-BALANCE-ADJUST-AUDIT-002` 已完成本地 Red / Green 并提交固化为能力证据；`dd442888`、`ea8f8800`、`632bd2f6`、`ca603eab`、`873e5f8c`、`a38776c5`、`bc7ffc0f`、`10853e2d`、`e81a8a25` 和 `ae8cb8a6` 保留为已消费能力证据，`da7d2ea test: 阻断契约夹具承载资金流断言` 和 `b3b9712 feat: 对齐资金底座GSD基线与交易回放能力` 只保留为 GSD-2 历史证据。 |
