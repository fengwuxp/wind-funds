...
- [ ] 2026-06-23 计划 `GSD2-AUTH-CHARGEBACK-DEPRECATION-CONSUME-001`：`FundsAuthorizationTransactionService#chargeback` 作为历史兼容方法保留但不再代表资金影响入口；后续补弃用、兼容 adapter 消费和测试，再评估删除窗口。
