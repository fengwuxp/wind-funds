...
| 当前 A0/A1 准入证据 | `4f0a43e docs: 记录 A0 只读验证证据`、`26144cc docs: 补齐 A1 直接交易准入卡`、`4dbad21 docs: 记录 CAD 完整验证证据`。 | 这些提交只作为 A1 直接交易事实红线 Execution Grant 的确认输入；未获用户确认前，不授权生产代码、测试代码、DDL/H2 schema 或运行时配置写入。 |
