 ...
 * </ul>
 */
public interface FundsInstructionLifecycleSaver {
     ...
     */
    void markSucceeded(@NonNull FundsInstructionLifecycleResult result, @Nullable String ledgerTransactionSn);
     ...
     * @param cause 失败原因
     */
    void markFailed(@NonNull FundsInstructionLifecycleResult result, @NonNull Throwable cause);
